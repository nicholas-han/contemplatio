...
export const estimateQuerySchema = z.object({ companyId: companyIdSchema, metricId: z.string().optional(), targetPeriodEnd: z.string().optional(), asOfFrom: z.string().optional(), asOfTo: z.string().optional(), limit: z.number().int().positive().max(5000).optional() })
